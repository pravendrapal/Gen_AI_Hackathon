...
import Logo from "/FarmBoost (1).png"
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white fixed left-0 right-0 transition-all">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="flex items-center ml-2 uppercase">
                <div>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <NavLink to="/login" className="cursor-pointer px-6 py-2 mt-2 bg-indigo-500 hover:bg-indigo-600 transition text-white rounded-full text-sm">
                    Login
                </NavLink>
            </div>
